<template>
  <div class="mt-8">
    ...
    <div class="relative mb-8" v-if="applicationDetails">
      ...
      <div class="absolute left-[19.5px] top-3 bottom-3 w-[1px]" style="
      ...
      <div v-for="(stage, index) in applicationDetails.role_stages" :key="stage.stage_id"
        ...
        <div class="ml-3 flex justify-between w-full pr-4" :class="{
          'flex-col':
            getStageStatus(stage.stage_sequence, applicationDetails.current_stage_sequence) !==
            'current',
        }">
          <div>
            <h5 class="text-base font-medium" :class="{
              'text-white':
                getStageStatus(
          ...
          <div v-if="
            getStageStatus(stage.stage_sequence, applicationDetails.current_stage_sequence) ===
            'current'
          " class="px-3 py-1 rounded-full text-xs font-medium h-6 flex items-center" :class="{
